          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-4 space-y-6">
              ...
              <div className="sticky top-6">
                ...
                {/* Benefits Card */}
                <div className="mt-6 relative group p-6 rounded-2xl bg-black/40 border border-zinc-800 hover:border-[#ab20fd]/30 transition-all duration-300">
                  <div className="absolute inset-0 bg-gradient-to-br from-[#ab20fd]/5 to-transparent opacity-0 group-hover:opacity-100 rounded-2xl transition-opacity duration-300" />
                  <div className="relative">
                    <div className="flex items-center gap-3 mb-4">
                    ...
                    <ul className="space-y-3">
                      {JobDesc.PerksandBenefits.map((perk, index) => (
                        <li key={index} className="flex items-start gap-3">
                          <span className="mt-2 h-1.5 w-1.5 rounded-full bg-[#ab20fd]" />
